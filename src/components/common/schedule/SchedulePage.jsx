...
import { getScheduleStatusColor, getScheduleStatusIcon } from "@/utils/userHelpers"
          ...
          return (
            <Card key={schedule.id} className="p-4 flex flex-col justify-between space-y-4 hover:shadow-lg transition-shadow">
              <div>
                ...
                <Badge
                  className={`${getScheduleStatusColor(schedule.status)} mt-3 p-1 flex items-center gap-1 text-white`}
                >
